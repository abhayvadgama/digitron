    ...
    if(f==false)
    {
        ...
        for (var i = 1; i <= quanitity; i++) {
            ...
            $('.total_serial_show').append('<div class="form-group col-lg-4 col-md-4 col-xs-12 ">' +
                ...
                '<input type="text" class="form-control edit_serial' + (i + parseInt(qserial)) + '" name="serial[]" id="" placeholder="Enter Serial Number ' + (i + parseInt(qserial)) + '" required maxlength="12">' +
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.trim() =='0')
                {
                    ...
                    $('#final_total').html('<td></td><td>'+final[9]+'</td><td></td><td>'+final[10]+'</td><td></td><td>'+final[11]+'</td><td>'+final[12]+'</td><td></td>');
